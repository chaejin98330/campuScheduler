...
# 인스턴스 생성
parser = argparse.ArgumentParser("Imageprocessing")
...
# 이미지 불러오기, 흑백으로 변환
file_path = "../data/image/" + args.file
...
output_file = args.name + "_" + args.id + ".json"

with open("../data/student/" + args.group + "/" + output_file, 'w') as f:
